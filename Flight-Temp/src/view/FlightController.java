...
public class FlightController implements Initializable, Observer {
    ...
    private static int flag;//this variable is to identify which button was pressed
    ...
    public void LoadDate() {
        ...
        if (v == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                bufferR = new BufferedReader(new FileReader(fileChooser.getSelectedFile()));
                String[] start=bufferR.readLine().split(cvsSplitBy);
                startX.setValue(Double.parseDouble(start[0]));
                startY.setValue(Double.parseDouble(start[1]));
                start=bufferR.readLine().split(cvsSplitBy);
...
//Event - Press on the circle
    EventHandler<MouseEvent> mouseCircleClicked =
    ...
    EventHandler<MouseEvent> mouseCircleMoved =
            new EventHandler<MouseEvent>() {
    ...
    EventHandler<MouseEvent> mouseCircleReleased = new EventHandler<MouseEvent>() {
                @Override
                public void handle(MouseEvent t) {
   ...
   //Get data from the mouse 
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if(location.getPath().contains("Flight.fxml")) {
            ...
            Joystick.setOnMousePressed(mouseCircleClicked);
            Joystick.setOnMouseDragged(mouseCircleMoved);
            Joystick.setOnMouseReleased(mouseCircleReleased);
